...
find ./documentation -type f -exec sed -i -e 's/\modules\b/controllers/g' {} \;
find ./documentation -type f -exec sed -i -e 's/\module\b/controller/g' {} \;
rename 's/global/routes/' ./documentation/music_recommender/*/*
rename 's/mixins/models/' ./documentation/music_recommender/*/*
rename 's/modules/controllers/' ./documentation/music_recommender/*/*
rename 's/module/controller/' ./documentation/music_recommender/*/*